...
<div class="card">
    ...
    <div style="margin-bottom: 14px;">
        <input type="text" id="filter-rad-orders" onkeyup="filterTable('filter-rad-orders','tbl-rad-orders')" placeholder="Search..." style="padding: 8px 14px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 0.88em; width: 260px; outline: none;">
    </div>
    <table id="tbl-rad-orders" style="width: 100%; border-collapse: collapse;">
        <thead>
